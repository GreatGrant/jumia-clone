...
import 'package:jumia_clone/features/product/presentation/widgets/details_appbar.dart';
import 'package:jumia_clone/features/product/presentation/widgets/strike_through_price.dart';

import '../../../../core/theme/colors.dart';
import '../../../../core/utils/data_time_util.dart';
...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: DetailsAppBar(title: 'Details'),
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 12,),
            PromotionsWidget(promotions: JumiaDataSource.promotions),
            SizedBox(height: 12,),
            DeliveryReturnsInfo(
              locations: JumiaDataSource.sampleLocations,
              currency: '₦',
              onDetailsPressed: () {
